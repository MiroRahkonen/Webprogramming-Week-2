...
function addUser(event) {
  ...
  for (row in rows) {
    var _username = row.firstChild().innerHTML;
  }
  ...
  table.innerHTML += "<tr><td>" + username + "</td><td>" + email + "</td><td>" + address + "</td><td>" + admin + "</td><td>" + "<img src=".concat(URL.createObjectURL(newImage), " height=\"64\" width=\"64\"></td></tr>");
}
